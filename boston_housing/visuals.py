...
def PredictTrials(X, y, fitter, data, client):
    ...
    for k in range(10):
        ...
        # Make a prediction
        pred = reg.predict([data[client]])[0]
        prices.append(pred)
...
def PredictTrials_with_multiple_params(X, y, fitter, params, data, client):
    """ Performs trials of fitting and predicting data. """
    ...
    for k in range(10):
        ...
        # Fit the data
        reg = fitter(X_train, y_train, params)
